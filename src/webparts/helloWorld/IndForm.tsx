      ...
      <div className={styles.container + " " +  styles}>
        ...
        <div className={styles.contactToolbar}>
         ...
         <div  className={styles["col-4"]}>
          ...
          <div className={styles.container + " " +  styles.myform}>
              ...
              <div className={styles["ms-TextField"]}>
                <div className="form-check">
                  <span>
                    ...
                    <input className={styles.formCheckInput} type="checkbox" id="gridCheck" />
                  </span>
                </div>
              </div>
            </div>
            ...
            <input type="text" className={styles["ms-TextField-field"]} id="formGroupExampleInput" placeholder=" " />
              ...
              <div>
                ...
                <div className={styles.province}>
                  <label className={styles.label} htmlFor="formGroupExampleInput">Province/State</label>
            ...
            <div className={styles["col-4"]}>
              <div>
                <div className={styles.contry}>
                  <label className={styles.label} htmlFor="formGroupExampleInput">Country</label>
                  <select className={styles.formControl} defaultValue="0" onChange={e=> this.selectCountry(e)} >
                    {
              ...
              <div>
                <div className={styles.postalcode}>
                  <label className={styles.label} htmlFor="formGroupExampleInput">Postal/Zip Code</label>
                  <input type="text" className={styles.formControl} maxLength= {8} id="formGroupExampleInput" placeholder=" " onChange={e => this.getValidator(e)} />
          ...
          <div className={styles.row}>
            <div className={styles["col-2"]}>
              <div className={styles.formGroup}>
                <label className={styles.label} htmlFor="formGroupExampleInput">Home Quarter</label>
                <input type="text" className={styles.formControl} id="formGroupExampleInput" placeholder=" " />
              </div>
            </div>
            <div className={styles["col-2"]}>
              <div className={styles.formGroup + " " + styles.alignResidence}>
                <div className={styles.formControl}>
                  <input className={styles.formCheckInput} type="checkbox" id="gridCheck" />
                  {/* <label className={styles.label} className="form-check-residence" htmlFor="gridCheck"> */}
                  <label className={styles.label} htmlFor="gridCheck">
        ...
        <div className={styles.row}>
          <div className={styles["col-2"]}>
          <div className={styles.formGroup + " " + styles.tax}>
              <label className={styles.label} htmlFor="formGroupExampleInput">GST#</label>
              <input type="text" className={styles.formControl} id="formGroupExampleInput" placeholder=" " maxLength={17}/>
            </div>
          </div>
          <div className={styles["col-2"]}>
          <div className={styles.formGroup + " " +  styles.tax}>
          ...
          <div className={styles.formGroup + " " +  styles.tax}>
              ...
              <input type="text" className={styles.formControl} id="formGroupExampleInput" placeholder=" " maxLength={8} />
            </div>
          </div>
          <div className={styles["col-2"]}>
          <div className={styles.formGroup + " " +  styles.tax}>
              <label className={styles.label} htmlFor="formGroupExampleInput">QST#</label>
              <input type="text" className={styles.formControl} id="formGroupExampleInput" placeholder=" " maxLength={15}/>
            </div>
          </div>
        </div>
        <hr/>
        ...
        <h5>Comments</h5>
          ...
          <div className={styles["col-11"]}>
           <div className={styles.formGroup + " " +  styles.customFormInput}>
           <input type="text"  className={styles.formControl + " " + styles.formControlTe} ref={node=>this.refe2 = node}  value={this.state.selectedComment["_gcomment"]} id="formGroupExampleInput" placeholder=" " onChange={(e)=>this.changeComment(e)} />
          ...
          <tr>
          <th scope="row">
          <div className={styles.formGroup + " " +  styles.formCheckAlign}>
